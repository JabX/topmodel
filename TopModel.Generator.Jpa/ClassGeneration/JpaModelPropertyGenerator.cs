...
{
    protected readonly IEnumerable<Class> _classes;
    protected readonly JpaConfig _config;
    protected readonly Dictionary<string, string> _newableTypes;
    ...
    protected JavaAnnotation NotNullAnnotation => new("NotNull", imports: $"{JavaxOrJakarta}.validation.constraints.NotNull");

    protected JavaAnnotation ValidAnnotation => new("Valid", imports: $"{JavaxOrJakarta}.validation.Valid");
    ...
    public IEnumerable<JavaAnnotation> GetDomainAnnotations(IProperty property, string tag)
    {
        ...
        {
            yield return new JavaAnnotation(name: annotation.Annotation, imports: annotation.Imports.ToArray());
        }
    }
    ...
    protected IEnumerable<JavaAnnotation> GetAnnotations(IProperty property, string tag)
    {
    ...
    protected IEnumerable<JavaAnnotation> GetAutogeneratedAnnotations(Class classe)
    {
    ...
    protected JavaAnnotation GetConvertAnnotation(CompositionProperty property, string tag)
    {
    ...
    protected IEnumerable<string> GetDefaultValueImports(IProperty property, string tag)
    {
        var defaultValue = _config.GetValue(property, _classes);
        if (property is AssociationProperty ap)
        {
    ...
    protected IEnumerable<JavaAnnotation> GetIdAnnotations(IProperty property)
    {
    ...
    protected IEnumerable<JavaAnnotation> GetManyToManyAnnotations(AssociationProperty property)
    {
    ...
    protected IEnumerable<JavaAnnotation> GetManyToOneAnnotations(AssociationProperty property, string tag)
    {
        var association = new JavaAnnotation(@$"{property.Type}", imports: $"{JavaxOrJakarta}.persistence.{property.Type}")
            .AddAttribute("fetch", "FetchType.LAZY", $"{JavaxOrJakarta}.persistence.FetchType")
    ...
    protected IEnumerable<JavaAnnotation> GetOneToManyAnnotations(AssociationProperty property)
    {
        var association = new JavaAnnotation(@$"{property.Type}", imports: $"{JavaxOrJakarta}.persistence.{property.Type}");
        if (property is ReverseAssociationProperty rap)
        {
    ...
    protected IEnumerable<JavaAnnotation> GetOneToOneAnnotations(AssociationProperty property)
    {
        var fk = ((IProperty)property).SqlName;
        var apk = property.Property.SqlName;
        var association = new JavaAnnotation(@$"{property.Type}", imports: $"{JavaxOrJakarta}.persistence.{property.Type}")
